...
function cms_settings() {
	...
	add_settings_field( 'autoresponder', __( 'Trigger autoresponder in CampaignMonitor', 'cms_plugin' ), 'cms_settings_autoresponder', 'cms_plugin', 'api' );
...
function cms_settings_autoresponder() {
	$cms_settings = ( array ) get_option( 'cms_settings' );
	echo '<input type="hidden" name="cms_settings[autoresponder]" value="0" />';
	echo '<input type="checkbox" name="cms_settings[autoresponder]" value="1" ' . checked( $cms_settings[ 'autoresponder' ], 1, false ) . ' />';
}
